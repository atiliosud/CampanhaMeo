...
{
    public class QuestionCreateSingleSelect
    {
        public QuestionCreateSingleSelect()
        {

        }
        public QuestionCreateSingleSelect(Guid surveyId, int numbOptions)
        {
            SurveyId = surveyId;
            if (numbOptions < 2)
            {
        ...
        internal Question ToModel()
        {
            return new Question()
            {
                ...
                Order = Order,
                IsMandatory = "sim",
                Content = new QuestionStructSingleSelect()
                {
                    Options = Options,
